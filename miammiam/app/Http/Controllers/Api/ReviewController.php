...
class ReviewController extends Controller
{
    ...
    public function store(StoreReviewRequest $request)
    {
        try {
            ...
            return $this->successResponse($avisData, 'Avis créé avec succès', 201);
    ...
    public function myReviews(Request $request)
    {
        try {
            ...
            $avis = Avis::where('id_utilisateur', $utilisateur->id_utilisateur)
                ->with(['menuItem', 'commande'])
            ...
            return $this->successResponse($avisData, 'Avis récupérés avec succès');
    ...
    /**
     * Récupérer les avis d'un plat spécifique (route publique - uniquement les avis approuvés)
     * 
     * GET /api/reviews/menu-item/{id}
     */
    public function getMenuItemReviews($id)
    {
        try {
            ...
            // Récupérer uniquement les avis approuvés pour ce plat
            $avis = Avis::where('id_menuitem', $id)
                ->where('type_avis', 'plat')
            ...
            return $this->handleException(
                $e,
                'Erreur lors de la récupération des avis du plat',
                ['id_menuitem' => $id]
            );
        }
    }
